...
fixit () {
curl -s https://raw.githubusercontent.com/louislam/vestacp-php-selector/master/scripts/sk-php${1}-centos.sh > /usr/local/vesta/data/templates/web/httpd/sk-php${1}.sh
